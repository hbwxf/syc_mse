library(GeMS)
plotdir <- file.path(getwd(),"..","Paper","Figures","Fig5_NatM.pdf")
...
p3 <- PlotParam("NatM",OMfile="SYC_3_changeM_3",EMvec="SYC_3_changeM_3")
...
#tiff(plotdir,width=170,height=85,units="mm",res=300)
pdf(plotdir,width=7,height=3.5)
