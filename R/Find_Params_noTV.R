...
# paramvec <- c(sqrt(log(CTLfile$OM$RzeroN))[Cindex],log(CTLfile$OM$sel50n)[1],log(CTLfile$OM$sel95n)[1],log(6E-7))
 paramvec <- c(sqrt(log(CTLfile$OM$RzeroN))[Cindex],log(6E-7))
